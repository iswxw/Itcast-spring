...
public class CodeGenerator {
    ...
    // 基础数据微服务 路径
    public static String webPath="/itcast-boot-quartz/src/main/java";
    /**
     * 读取控制台内容
     */
    ...
    public static void main(String[] args) {
        ...
        dsc.setDbType(DbType.MYSQL)
                ...
                .setUrl("jdbc:mysql://localhost:3306/quartz?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai")
                .setUsername("root")
                .setPassword("123456");
